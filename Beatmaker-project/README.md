BeatMaker is an music application. Its purpose is to allow any user to create beats on repeat. Anyone is able to change sounds using the dropdown button and switch the tempo to provide a fun experience.
